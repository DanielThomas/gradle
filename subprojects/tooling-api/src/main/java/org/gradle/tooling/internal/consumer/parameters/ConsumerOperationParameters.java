...
public class ConsumerOperationParameters implements BuildOperationParametersVersion1, BuildParametersVersion1, BuildParameters {
    ...
    public List<GradleParticipantBuild> getBuilds() {
        ...
        List<GradleParticipantBuild> builds = new LinkedList<GradleParticipantBuild>(((CompositeConnectionParameters) parameters).getBuilds());
        for (GradleParticipantBuild build : ((CompositeConnectionParameters) parameters).getBuilds()) {
